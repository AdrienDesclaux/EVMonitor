  ...
  return (
    <div className="sideBar-bottomBar">
      <div className="h-full">
        <ul className="hidden w-48 h-full pt-24 md:block menu menu-vertical lg:menu-horizontal rounded-box bg-blue_nav shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          {isLogged ? (
            <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-10 flex justify-around shadow-lg btm-nav md:hidden bg-blue_nav ">
        {isLogged ? (
          <>
            <Link to="/dashboard">
